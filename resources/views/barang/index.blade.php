            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <td class="py-4 px-4 text-center">
                    <div class="flex items-center justify-center gap-1.5">
                        ...
                        <a href="{{ route('barang.show', $item->id) }}" title="Detail Barang" class="p-2 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-lg transition-colors shadow-sm">
                        ...
                        <a href="{{ route('barang.barcode', $item->id) }}" target="_blank" title="Cetak Barcode" class="p-2 bg-purple-50 hover:bg-purple-100 text-purple-600 rounded-lg transition-colors shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
