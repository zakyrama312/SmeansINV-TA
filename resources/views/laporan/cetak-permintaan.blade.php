...
<body onload="window.print()">
    <div class="max-w-[1400px] mx-auto p-4">
        ...
        <div class="text-center mb-6">
            <h1 class="font-bold text-xl uppercase tracking-wider mb-1">Laporan Pengeluaran Bahan Habis Pakai</h1>
        ...
        <table class="kir-table">
            <thead>
                <tr>
                    ...
                    <th class="w-48">NAMA PEMINTA</th>
                    <th class="w-24">KELAS</th>
                    <th class="w-auto">DAFTAR BAHAN DIMINTA (JUMLAH)</th>
                    <th class="w-24">TGL PENGAJUAN</th>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="7" class="text-center py-6 italic">Tidak ada data permintaan yang sesuai.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
