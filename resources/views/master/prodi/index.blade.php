            ...
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="w-full md:w-2/3">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                            <h3 class="font-semibold text-gray-800">Daftar Prodi</h3>
                            <span
                                class="text-xs bg-blue-100 text-blue-800 px-2.5 py-0.5 rounded-full font-medium">{{ $prodis->count() }}
                                Prodi</span>
                        </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500">
                                <thead class="text-xs text-gray-500 uppercase bg-white border-b border-gray-100">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-4 font-semibold">Nama Prodi</th>
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-gray-800 font-medium">{{ $item->nama_prodi }}</td>
                                    ...
                                    <tr>
                                        <td colspan="3" class="px-6 py-8 text-center text-gray-500">
                                            Belum ada data prodi. (Contoh: RPL, TKJ, dll.)
                                        </td>
                                    </tr>
                                    @endforelse
                                </tbody>
                ...
                <div class="w-full md:w-1/3">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-6">
                        <h3 class="font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-100">Tambah Prodi Baru
                        </h3>

                        <form action="{{ route('prodi.store') }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nama Prodi <span
                                        class="text-red-500">*</span></label>
                                <input type="text" name="nama_prodi" required
                                    placeholder="Contoh: Alat Jaringan, Kabel..."
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('nama_prodi') border-red-500 @enderror"
