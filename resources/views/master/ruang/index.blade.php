            ...
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="w-full md:w-2/3">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                            <h3 class="font-semibold text-gray-800">Daftar Ruang</h3>
                            <span
                                class="text-xs bg-blue-100 text-blue-800 px-2.5 py-0.5 rounded-full font-medium">{{ $ruangs->count() }}
                                Ruang</span>
                        </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500">
                                <thead class="text-xs text-gray-500 uppercase bg-white border-b border-gray-100">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-4 font-semibold">Nama Ruang</th>
                                        <th scope="col" class="px-6 py-4 font-semibold text-right">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-50">
                                    @forelse($ruangs as $index => $item)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 text-center font-medium text-gray-900">{{ $index + 1 }}
                                        </td>
                                        <td class="px-6 py-4 text-gray-800 font-medium">{{ $item->nama_ruang }}</td>
                                    ...
                                    <tr>
                                        <td colspan="3" class="px-6 py-8 text-center text-gray-500">
                                            Belum ada data Ruang. (Contoh: Lab RPL, Lab MP, dll)
                                        </td>
                                    </tr>
                                    @endforelse
                                </tbody>
                ...
                <div class="w-full md:w-1/3">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-6">
                        <h3 class="font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-100">Tambah Ruang Baru
                        </h3>

                        <form action="{{ route('ruang.store') }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nama Ruang <span
                                        class="text-red-500">*</span></label>
                                <input type="text" name="nama_ruang" required placeholder="Contoh: Lab RPL, Lab MP, dll"
