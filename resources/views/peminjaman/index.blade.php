                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors row-transaksi">
                                ...
                                <td class="py-4 px-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        @elseif($item->status == 'dipinjam')
                                        @php $phone = str_starts_with($item->no_hp, '0') ? '62' . substr($item->no_hp,
                                        1) : $item->no_hp; @endphp
                                        <a href="https://wa.me/{{ $phone }}" target="_blank"
                                            class="inline-flex items-center px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-green-600 text-xs font-bold rounded-md transition-colors">
                                            WA
                                        </a>
