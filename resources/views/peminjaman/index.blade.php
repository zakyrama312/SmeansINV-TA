                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors row-transaksi">
                                ...
                                <td class="py-4 px-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        return "- " . ($detail->barang->nama_barang ?? 'Barang Terhapus') . " (" .
                                        $detail->jumlah . " unit)";
                                        })->implode("\n");
                                        ...
                                        $pesan .= "Ini pesan otomatis dari Admin Laboratorium $prodi SMK Negeri 1
                                        Slawi.\n";
                                        $pesan .= "Kami ingin mengingatkan terkait transaksi peminjaman dengan kode
                                        *{$item->kode_transaksi}*.\n\n";
                                        $pesan .= "Daftar Alat/Barang:\n{$daftarBarang}\n\n";

                                        // Cek status untuk menyesuaikan pesan
                                        if ($item->status == 'dipinjam') {
                                        $pesan .= "Mohon untuk menjaga kondisi barang dan mengembalikannya tepat waktu
                                        sesuai batas peminjaman. Terima kasih!";
                                        } elseif ($item->status == 'pending') {
                                        $pesan .= "Pengajuan peminjaman kamu sedang kami tinjau. Silakan temui teknisi
                                        lab untuk konfirmasi fisik.";
                                        } else {
                                        ...
                                        <a href="{{ $linkWa }}" target="_blank" title="Hubungi via WhatsApp"
                                            class="p-2 bg-green-50 hover:bg-green-100 text-green-600 rounded-lg transition-colors shadow-sm inline-flex items-center justify-center">
